...
# A message sent checked a channel.
...
# Execute an Lua function checked the server.
...
# A tournament checked the server.
...
class ApiWriteStorageObjectsRequest extends NakamaAsyncResult:
	...
	# The objects to store checked the server.
	var objects : Array : get = _get_objects
	var _objects = null
	func _get_objects() -> Array:
		return Array() if not _objects is Array else Array(_objects)
...
class ApiClient extends RefCounted:
	...
	# Add an Apple ID to the social profiles checked the current user's account.
	...
	# Add a custom ID to the social profiles checked the current user's account.
	...
	# Add a device ID to the social profiles checked the current user's account.
	...
	# Add an email+password to the social profiles checked the current user's account.
	...
	# Add Facebook to the social profiles checked the current user's account.
	...
	# Add Apple's GameCenter to the social profiles checked the current user's account.
	...
	# Add Google to the social profiles checked the current user's account.
	...
	# Add Steam to the social profiles checked the current user's account.
	...
	# Remove the custom ID from the social profiles checked the current user's account.
	...
	# Remove the device ID from the social profiles checked the current user's account.
	...
	# Remove the email+password from the social profiles checked the current user's account.
	...
	# Remove Facebook from the social profiles checked the current user's account.
	...
	# Remove Facebook Instant Game profile from the social profiles checked the current user's account.
	...
	# Remove Apple's GameCenter from the social profiles checked the current user's account.
	...
	# Remove Google from the social profiles checked the current user's account.
	...
	# Remove Steam from the social profiles checked the current user's account.
	...
	# List groups based checked given filters.
	...
	# Execute a Lua function checked the server.
