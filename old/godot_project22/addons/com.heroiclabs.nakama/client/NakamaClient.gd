...
# Set the timeout in seconds checked requests sent to the server.
var timeout : int
...
# Link an Apple ID to the social profiles checked the current user's account.
# @param p_session - The session of the user.
...
# Add Facebook Instant Game to the social profiles checked the current user's account.
# @param p_session - The session of the user.
# @param p_token - An OAuth access token from the Facebook SDK.
# @param p_import - If the Facebook friends should be imported.
# Returns a task which represents the asynchronous operation.
...
# List groups checked the server.
# @param p_session - The session of the user.
...
# Fetch a list of matches active checked the server.
# @param p_session - The session of the user.
...
# @param p_label - The label to filter the match list checked.
...
# Execute a function with an input payload checked the server.
# @param p_session - The session of the user.
# @param p_id - The ID of the function to execute checked the server.
...
# Execute a function checked the server without a session.
...
# Remove the Apple ID from the social profiles checked the current user's account.
# @param p_session - The session of the user.
...
# Update the current user's account checked the server.
# @param p_session - The session for the user.
