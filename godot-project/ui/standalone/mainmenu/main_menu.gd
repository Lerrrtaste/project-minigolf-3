...
func _ready():
	...
	Networker.connect("matchmaking_started",Callable(self,"_on_Networker_matchmaking_started"))
	Networker.connect("matchmaking_ended",Callable(self,"_on_Networker_matchmaking_ended"))
	Networker.connect("matchmaking_matched",Callable(self,"_on_Networker_matchmaking_matched"))
	
	Networker.connect("socket_connected",Callable(self,"_on_Networker_socket_connected"))
	Networker.connect("socket_connection_failed",Callable(self,"_on_Networker_socket_connection_failed"))
...
func refresh_map_selection():
	...
	var public_maps = await MapStorage.list_public_maps_async().completed
...
func _on_Networker_matchmaking_matched(matched):
	...
	get_tree().change_scene_to_file("res://scenes/match_default/MatchDefault.tscn")
